 ...
 * client/server login authentication by the usual key/data system. Besides, I
 * got the creeps watching the password posted unencrypted via http requests.
 ...
 * strings. Since anyone who is trapping the http requests can actually send you
 * the same encrypted string, I suggest you use the client's IP address as the
 * base for the key generation. Since IP address spoofing is not a problem, this
 * authentication method is not a very secured solution. If you need a full
 * proof solution use ssl. However, this one, sure beats nothing. Feel free to
 * do with it whatever you want</b>
 * <p>
 * <b>This Class is an Abstract Class, to make sure you do not create any new
 * instances of it. It does not throw any exceptions and the code is much more
 * 'C' like than pure object oriented. There are no implemented interfaces and
 * no inheritance in use. In fact, it is written as close as possible to the
 * original JavaScript code. I did not test tweaking the instance variables but
 * if you do change them, make sure to apply the same change in the 'sha1.js'
 * library or you won't get the same encrypted strings. You can call each one of
 * the 6 work methods by using something like: SHA1.hex_hmac_sha1("key",
 * "data"); They are the only public methods. All are public and static. You
 * have no reason to call the private ones anyway.
 * </p>
 * </b>
 * <p>
 * The 'sha1.js' is a JavaScript implementation of the Secure Hash Algorithm,
 * SHA-1, as defined in FIPS PUB 180-1. JavaScript Version 2.1 Copyright Paul
 * Johnston 2000 - 2002. Other contributors to JavaScript version: Greg Holt,
 * Andrew Kepert, Ydnar, Lostinet Distributed under the BSD License
 * </p>
 * <p>
 * See <a
 * href="http://pajhome.org.uk/crypt/md5">http://pajhome.org.uk/crypt/md5</a>
 * for details.
 * </p>
 * <p>
 * <b>Author: </b>T.N.Silverman (C.T.Xm - SiA Riga, LV) <a
 * href="mailto:tnsilver@ctcm.com">mailto:tnsilver@ctxm.com</a> <br>
 * Creation date: (3/27/2004 5:57:00 PM)
 * </p>
 * <p>
 * Don't forget to visit my company, <b>CTXM</b> site at <a
 * href="http://www.ctxm.com">http://www.ctxm.com</a> where you will find
 * reference to all of the games this code is used in.
 */
public abstract class SHA1 {
	private static final boolean hexcase = false;/*
												 * hex output format. false -
												 * lowercase; true - uppercase
												 */
	private static final String b64pad = "="; /*
											 * base-64 pad character. "=" for
	 ...
	 * arguments and returns either hex or base-64 encoded strings Creation
	 * date: (3/27/2004 6:05:10 PM)
	 * 
	...
	/**
	 * Convert an array of big-endian words to a base-64 string Creation date:
	 * (3/27/2004 6:05:10 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	...
	/**
	 * Convert an array of big-endian words to a string Creation date:
	 * (3/27/2004 6:05:10 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 ...
	 * originally was. Creation date: (3/27/2004 6:05:10 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 * @return java.lang.String
	 ...
	 * all previous cells at their previous indexes. Creation date: (3/27/2004
	 * 6:05:10 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 ...
	 * object. Creation date: (3/27/2004 6:05:10 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 * @return int[]
	...
	/**
	 * Calculate the HMAC-SHA1 of a key and some data Creation date: (3/26/2004
	 * 1:05:01 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 ...
	 * to test with different values. Creation date:(3/27/20046:05:10PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
	 * @return java.lang.String
	...
	/**
	 * This is a boolean returnig test function that exists in the sha1.js
	 * library. If it returns 'false' something is wrong. Creation date:
	 * (3/26/2004 1:05:01 PM)
	 * 
	 * @author T.N.Silverman
	 * @version 1.0.0
